...
if (isset($_POST['insert'])) {
	...
	$query = "INSERT INTO bank (id,nama_bank, alamat, telepon) VALUES ('" . $id . "','" . $nama_bank . "', '" . $alamat . "', '" . $telepon . "')";
...
if (isset($_POST['update'])) {
	...
	$query = "UPDATE bank SET nama_bank='$nama_bank', alamat='$alamat', telepon='$telepon' WHERE id='$id'";
